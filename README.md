...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `32.5µs` | `92.1µs` |
| [Day 2](./src/bin/02.rs) | `20.9µs` | `51.0µs` |
| [Day 3](./src/bin/03.rs) | `353.8µs` | `1.0ms` |
| [Day 4](./src/bin/04.rs) | `186.8µs` | `185.0µs` |
| [Day 5](./src/bin/05.rs) | `27.1µs` | `55.8µs` |
| [Day 6](./src/bin/06.rs) | `159.0ns` | `220.0ns` |
| [Day 7](./src/bin/07.rs) | `226.2µs` | `311.4µs` |
| [Day 8](./src/bin/08.rs) | `323.0µs` | `2.0ms` |
| [Day 9](./src/bin/09.rs) | `83.5µs` | `84.0µs` |
| [Day 10](./src/bin/10.rs) | `135.5µs` | `237.5µs` |
| [Day 11](./src/bin/11.rs) | `1.6ms` | `1.6ms` |
| [Day 12](./src/bin/12.rs) | `457.3µs` | `3.6ms` |
